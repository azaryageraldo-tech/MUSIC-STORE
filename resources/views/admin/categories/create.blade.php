                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" class="pl-10 mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" placeholder="Masukkan nama kategori" required autofocus>
                            </div>
                            <p class="mt-1 text-xs text-gray-500">Nama kategori akan otomatis dikonversi menjadi slug.</p>
                        </div>
